...
###Corr?lation entre les traits au J1
...
### la diversit? fonctionnelle Fondamentale (SF)
...
###La diversit? fonctionnelle fondamentale (SLA)
setwd("C:/Users/polyc/OneDrive - UQAM/ma?trise en biologie/Exp?rimentation/Exp?rience 2/Donn?es")
J1 <- read.csv("J1.csv", header = TRUE, sep = ";")
J20 <- read.csv("J20.csv", header = TRUE, sep = ";")
J40 <- read.csv("J40.csv", header = TRUE, sep = ";")
...
###La diversit? fonctionnelle fondamentale (MI)
setwd("C:/Users/polyc/OneDrive - UQAM/ma?trise en biologie/Exp?rimentation/Exp?rience 2/Donn?es")
J1 <- read.csv("J1.csv", header = TRUE, sep = ";")
J20 <- read.csv("J20.csv", header = TRUE, sep = ";")
J40 <- read.csv("J40.csv", header = TRUE, sep = ";")
...
###La diversit? fonctionnelle fondamentale (ALL)
setwd("C:/Users/polyc/OneDrive - UQAM/ma?trise en biologie/Exp?rimentation/Exp?rience 2/Donn?es")
J1 <- read.csv("J1.csv", header = TRUE, sep = ";")
J20 <- read.csv("J20.csv", header = TRUE, sep = ";")
J40 <- read.csv("J40.csv", header = TRUE, sep = ";")
...
###Diff?rence des traits entre J60 et J1
setwd("C:/Users/polyc/OneDrive - UQAM/ma?trise en biologie/Exp?rimentation/Exp?rience 2/Donn?es/r?sultats traits")
...
##SF
boxplot(Diff.Lm$Diff.SF ~ Diff.Lm$Esp.Compagne, main = "Diff?rence dans la SF de Lm entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SF", cex.axis =0.5)

boxplot(Diff.Sp$Diff.SF ~ Diff.Sp$Esp.Compagne, main = "Diff?rence dans la SF de Sp entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SF", cex.axis =0.5)

boxplot(Diff.Wc$Diff.SF ~ Diff.Wc$Esp.Compagne, main = "Diff?rence dans la SF de Wc entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SF", cex.axis =0.5)

boxplot(Diff.Lt$Diff.SF ~ Diff.Lt$Esp.Compagne, main = "Diff?rence dans la SF de Lt entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SF", cex.axis =0.5)

#MI
boxplot(Diff.Lm$Diff..MI ~ Diff.Lm$Esp.Compagne, main = "Diff?rence dans la MI de Lm entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de MI", cex.axis =0.5)

boxplot(Diff.Sp$Diff..MI ~ Diff.Sp$Esp.Compagne, main = "Diff?rence dans la MI de Sp entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de MI", cex.axis =0.5)

boxplot(Diff.Wc$Diff..MI ~ Diff.Wc$Esp.Compagne, main = "Diff?rence dans la MI de Wc entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de MI", cex.axis =0.5)

boxplot(Diff.Lt$Diff..MI ~ Diff.Lt$Esp.Compagne, main = "Diff?rence dans la MI de Lt entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de  MI", cex.axis =0.5)

#SLA
boxplot(Diff.Lm$Diff.SLA ~ Diff.Lm$Esp.Compagne, main = "Diff?rence dans la SLA de Lm entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SLA", cex.axis =0.5)

boxplot(Diff.Sp$Diff.SLA ~ Diff.Sp$Esp.Compagne, main = "Diff?rence dans la SLA de Sp entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SLA", cex.axis =0.5)

boxplot(Diff.Wc$Diff.SLA ~ Diff.Wc$Esp.Compagne, main = "Diff?rence dans la SLA de Wc entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de SLA", cex.axis =0.5)

boxplot(Diff.Lt$Diff.SLA ~ Diff.Lt$Esp.Compagne, main = "Diff?rence dans la SLA de Lt entre le J60 et le J1",
        xlab = "Esp?ce compagne", ylab = "Diff. de  SLA", cex.axis =0.5)



### la diversit? fonctionnelle Fondamentale 2 (ALL)
...
### la diversit? fonctionnelle r?alis?e (ALL)
...
DFgraf <- barplot(moyDF, ylab = "Dispersion fonctionnelle", xlab = "indice de DF", names.arg = c("DFf", "DFf2", "DFr"),
                   main = "Diff?rence entre les indices de DF", ylim = c(0, 10)) 
...
plot(SE ~ RFD, data = J60, main = "Se en fonction de DFr?alis?e") 
abline(SEDFrlm)
summary(SEDFrlm)
###pas significaitf###
...
##NEDFflm
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(NEDFflm) ~ fitted(NEDFflm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 

#Normalit? des r?sidus
qqnorm(rstudent(NEDFflm))
qqline(rstudent(NEDFflm))
shapiro.test(NEDFflm$residuals)
#la normalit? semble respect?e
...
#pas de valeur sup?rieure ? 1, donc pas d'influence particuli?re d'une observation


##NEDFf2lm
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(NEDFf2lm) ~ fitted(NEDFf2lm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(NEDFrlm) ~ fitted(NEDFrlm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(CEDFflm) ~ fitted(CEDFflm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(CEDFf2lm) ~ fitted(CEDFf2lm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(CEDFrlm) ~ fitted(CEDFrlm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(SEDFflm) ~ fitted(SEDFflm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#la normalit? n'est pas respect?e
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(SEDFf2lm) ~ fitted(SEDFf2lm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
...
#Valeurs extr?mes et homog?m?it? des variances
par(mfrow=c(2,2))
plot(rstudent(SEDFrlm) ~ fitted(SEDFrlm),main = "R?sidus de student",
     ylab = "R?sidus de Student", xlab = "Valeurs pr?dites")
##Pas de valeur extr?me ni de patron particulier. 
